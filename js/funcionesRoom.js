...
function getRoom(){
    $.ajax({
        url:"http://140.84.185.32:8080/api/Room/all",
        type:"GET",
        datatype:"JSON",
...
function postRoom(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://140.84.185.32:8080/api/Room/save",
        type:"POST",
        datatype:"JSON",
...
function putRoom(idBotonActualizar){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://140.84.185.32:8080/api/Room/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteRoom(idBotonBorrar){
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        $.ajax({
            url:"http://140.84.185.32:8080/api/Room/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
            contentType:"application/JSON",
